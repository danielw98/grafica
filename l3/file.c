...
void verifica_autointersectii(void);
...
void initializeaza_punctele_an4(Point *A, Point *B, Point *C, Point *D)
{
    A->x = 0; A->y = 40;
    B->x = 40; B->y = 0;
    C->x = -10; C->y = -10;
...
void verifica_autointersectii(void)
{
    ...
    int i;
    initializeaza_punctele_an4(&A,&B,&C,&D);
